 ...
 */
public let whitespace = char(NSCharacterSet.whitespaces(), name: "whitespace")
 ...
 */
public let newline = char(NSCharacterSet.newlines(), name: "newline")
 ...
 */
public let whitespacesOrNewline = char(NSCharacterSet.whitespacesAndNewlines(), name: "whitespacesOrNewline")
...
/**
 ...
 Numbers.
 */
public let digit = char(NSCharacterSet.decimalDigits(), name: "digit")
...
*/
public let alphanumeric = char(NSCharacterSet.alphanumerics(), name: "alphanumeric")
